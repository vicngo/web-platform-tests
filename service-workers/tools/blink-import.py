...
def testharness_helpers(line):
    if abs_testharness_helpers_re.findall(line):
        return False, abs_testharness_helpers_re.sub(r"\1testharness-helpers.js", line)
...
def copy_local_files(out_root, tmp_dir):
...
def main():
    ...
    copy_local_files(out_root, work_path)
